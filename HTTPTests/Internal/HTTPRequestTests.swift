...
class HTTPRequestTests: XCTestCase {
    ...
    func testSetAuthorizationWithBasicToken() {
        _ = sut.setAuthorization(basicToken: "ABCDEFG")
        
        XCTAssertEqual(sut.urlRequest?.value(forHTTPHeaderField: "Authorization"), "Basic ABCDEFG")
    }
    
    func testSetAuthorizationWithBearerToken() {
        _ = sut.setAuthorization(bearerToken: "ABCDEFG")
        
        XCTAssertEqual(sut.urlRequest?.value(forHTTPHeaderField: "Authorization"), "Bearer ABCDEFG")
    }
